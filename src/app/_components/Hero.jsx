    ...
    return (
        <div className='w-full lg:h-[85vh] overflow-hidden flex items-center'>
            ...
            <div className='absolute px-4 lg:top-40 lg:px-20'>
                <h1 className='text-3xl md:text-5xl font-bold text-white '>HERO TEXT</h1>
                <p className='text-white font-semibold text-xl md:text-3xl mt-3'>Lorem ipsum dolor sit amet.</p>
            </div>
        </div>
    )
}
